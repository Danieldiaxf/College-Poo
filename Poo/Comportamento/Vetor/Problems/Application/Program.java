package Comportamento.Vetor.Problems.Application; // Define o pacote onde esta classe está localizada

import java.util.Scanner; // Importa a classe Scanner (para ler entrada do usuário)
import Comportamento.Vetor.Problems.entities.People; // Importa a definição da classe 'People'
